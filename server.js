...
app.post('/analyze', function(req, res) {
  ...
  fetch('https://api.anthropic.com/v1/messages', {
    ...
    body: JSON.stringify({ model: 'claude-haiku-4-5-20251001', max_tokens: 800, messages: [{ role: 'user', content: 'Analiza este documento y devuelve SOLO JSON sin markdown:\n{\"titulo\":\"...\",\"capitulos\":[{\"nombre\":\"...\",\"buscar\":\"primeras 20 letras unicas\"}]}\nMaximo 8 secciones. Texto:\n' + text.substring(0, 4000) }] })
